...
class SIMPLEBAKER_Preferences(AddonPreferences):
    ...
    map_base_color: _map_property("Base Color")
    map_metallic: _map_property("Metallic")
    map_alpha: _map_property("Alpha")
    map_smoothness: _map_property("Smoothness")
    map_transmission_weight: _map_property("Transmission Weight")
    map_specular_ior_level: _map_property("Specular IOR Level")
    map_coat_weight: _map_property("Coat Weight")
    map_coat_roughness: _map_property("Coat Roughness")
    map_sheen_weight: _map_property("Sheen Weight")
    map_subsurface_weight: _map_property("Subsurface Weight")
    pack_orm: _map_property("ORM (AO, Roughness, Metallic)")
    pack_gltf: _map_property("glTF Metallic-Roughness")
    pack_unity_mask: _map_property("Unity Mask Map")
    pack_base_color_alpha: _map_property("Base Color + Alpha")
